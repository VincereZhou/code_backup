...
parser = argparse.ArgumentParser(prog="compare_snps", description='compare common samples in two genotype files for common SNPs')
...
parser.add_argument("--save-temp", required=False, default="no",
    help='''save temporary files or not ,must be yes or no, default is no. 
            ''')
parser.add_argument("--out", required=False, default="cmp_common_samples.txt",
    help='''out file name, default is "cmp_common_samples.txt". 
            ''')
...
#打印软件版本
print(" ---------------------------------------------")
print("|             compare_snps.py              |")
print("|                                             |")
print("|             2021 - Version 1.1              |")
print("|          (lase update: Aug 07, 2021)        |")
